...
5. Подготовить раздел анализа тенденций по статьям arXiv.
...
### 7.2. Сводная таблица выбранных исследованных работ
...
- Настроен мониторинг и наблюдаемость:
  ...
  - создан Grafana-дашборд с панелями:
    ...
    - **Memory usage by pod**
    - **Pods readiness**
- Выполнен анализ тенденций по статьям arXiv (2024–2025).
